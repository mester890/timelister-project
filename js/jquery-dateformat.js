...
(function($) {
  var daysInWeek          = ['Søndag', 'Mandag', 'Tirsdag', 'Onsdag', 'Torsdag', 'Fredag', 'Lørdag'];
  var shortDaysInWeek     = ['Søn', 'Man', 'Tir', 'Ons', 'Tor', 'Fre', 'Lør'];
  var shortMonthsInYear   = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun',
                              'Jul', 'Aug', 'Sep', 'Okt', 'Nov', 'Des'];
  var longMonthsInYear    = ['Januar', 'Februar', 'Mars', 'April', 'Mai', 'Juni',
